...
chcp 65001>nul
cls
echo ===== MANIOBRAS ESTÁTICAS DE PERCEPCIÓN / RASTREAR =====
...
set /P "ModTiempo=El personaje pasa tiempo buscando (S/N): "
...
set "ModTiempo=+00"
echo Valor no reconocido, se interpreta como 'N'
...
:: RESULTADOS
echo.
node maniobrasestaticas "!mest P%Tirada%;%BonifME%%ModDificultad%%ModTiempo%%Modificadores%"
node maniobrasestaticas "!mest P%Tirada%;%BonifME%%ModDificultad%%ModTiempo%%Modificadores%" >> MERP.log
