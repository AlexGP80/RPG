...
chcp 65001>nul
cls
echo ===== MANIOBRAS ESTÁTICAS ABRIR CERRADURAS / DESACTIVAR TRAMPAS =====
...
:: RESULTADOS
echo.
node maniobrasestaticas "!mest A%Tirada%;%BonifME%%ModDificultad%%Modificadores%"
node maniobrasestaticas "!mest A%Tirada%;%BonifME%%ModDificultad%%Modificadores%" >> MERP.log
