...
echo.
set "Modificadores="
echo Introduzca los modificadores pertinentes:
echo   -30 Si el dominio mágico del sortilegio es distinto al del personaje.
echo   -10 Si el personaje no sabe cuál es el sortilegio o la capacidad.
echo   +20 Si el personaje sabe qué sortilegio o capacidad es.
echo   +30 Si el personaje puede lanzar el sortilegio intrínsecamente,
echo          es decir, pertenece a una lista que ha aprendido y el nivel
echo          del sortilegio es menor o igual al nivel del personaje.
echo +-var Otros modificadores a discreción del DJ.
...
:: RESULTADOS
echo.
node maniobrasestaticas "!mest L%Tirada%;%BonifME%%ModDificultad%%Modificadores%"
node maniobrasestaticas "!mest L%Tirada%;%BonifME%%ModDificultad%%Modificadores%" >> MERP.log
