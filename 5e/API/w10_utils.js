...
function clima(msg) {
		...
		if (params.length < 1) {
			console.log("ERROR !clima main: faltan parámetros");
			return;
		}
		...
		if (isNaN(mes)) {
			console.log("ERROR !clima main: parámetro mes incorrecto: " + params[0]);
			return;
		}
...
console.log(clima(process.argv[2]));